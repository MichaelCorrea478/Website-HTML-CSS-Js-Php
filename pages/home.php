<section class="banner-principal">
    ...
    <div style="background-image: url('<?php echo INCLUDE_PATH; ?>imagens/marcus-aurelius2.jpg')" class="banner-single"></div>
    <div style="background-image: url('<?php echo INCLUDE_PATH; ?>imagens/marcus-aurelius3.jpg')" class="banner-single"></div>
...
<section id="sobre" class="descricao-autor">
    <div class="center">
        ...
        <div class="w50 left">
            <img class="right" src="<?php echo INCLUDE_PATH; ?>imagens/marcus-aurelius.jpg" alt="autor">
        </div> <!-- w50 -->
        <div class="clear"></div>
    </div> <!-- center -->
